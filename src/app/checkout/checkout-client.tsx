        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_390px]">
          <section>
            {step === "products" && <div className="space-y-6">
              <ProductCard label="Core System" title={products.carry.name} note="Includes 1 VISR Link · Diecast car sold separately" price={products.carry.price} stock={products.carry.stock}><QuantityControl value={carryQty} max={Math.min(products.carry.stock, 3)} onChange={setCarryQty} /></ProductCard>
