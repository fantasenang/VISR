    ...
    >
      ...
      <style jsx>{`
        ...
        .halo-panel__sticky {
          ...
          isolation: isolate;
          background:
            radial-gradient(circle at 50% 41%, rgb(var(--halo-rgb) / 0.09), transparent 45%),
            linear-gradient(180deg, #020202 0%, #040404 100%);
        }
        ...
        .halo-panel__copy {
          ...
          transition: opacity 600ms ease 220ms, transform 800ms cubic-bezier(0.22, 1, 0.36, 1) 220ms;
        }

        .halo-panel__copy p {
          margin: 0 0 0.8rem;
          color: rgb(var(--halo-rgb) / 0.82);
          font-size: 0.68rem;
        ...
        .halo-panel[data-active="true"] .halo-panel__light,
        .halo-panel[data-active="true"] .halo-panel__image,
        .halo-panel[data-active="true"] .halo-panel__copy {
          opacity: 1;
        }
        ...
        .halo-ending {
          ...
          background: radial-gradient(circle at 50% 50%, rgb(var(--active-rgb) / 0.045), transparent 43%);
        }
