  ...
  return (
    <div className="halo-artifact-shell" style={variables} data-halo-spill={animated ? "true" : undefined}>
      <svg className="halo-artifact" viewBox="0 0 1200 720" role="img" aria-label={`${halo.name} VISR display system`}>
        ...
        <ellipse cx="615" cy="552" rx="350" ry="34" fill="var(--halo-edge)" opacity="0.12" filter={`url(#${glowFilter})`} />
        <ellipse cx="615" cy="560" rx="295" ry="17" fill="var(--halo-edge)" opacity="0.3" filter={`url(#${glowFilter})`} />
        ...
        <g opacity="0.96">
          <path d="M228 182H612" stroke="var(--halo-edge)" strokeOpacity="0.72" strokeWidth="8" strokeLinecap="round" filter={`url(#${glowFilter})`} />
          <path d="M228 182H612" stroke="var(--halo-soft)" strokeWidth="1.9" strokeLinecap="round" />
  ...
  return (
    ...
    >
      ...
      <div className="halo-mobile">
        ...
        <div className="halo-mobile__pagination visr-container" aria-label={`${activeHalo.name} Halo selected`}>
          <div>
            {halos.map((halo, index) => (
              <button
                key={halo.slug}
          ...
          <span>{activeHalo.name} Halo</span>
        </div>
      </div>
      ...
      <style jsx>{`
        ...
        .halo-stage__spill {
          ...
          display: block;
          border-radius: 999px;
          background: rgb(var(--halo-rgb) / 0.42);
          filter: blur(54px);
        ...
        .halo-stage__spill--primary {
          ...
          width: 62%;
          height: 1px;
          box-shadow: 0 0 130px 48px rgb(var(--halo-rgb) / 0.28);
        }
        ...
        .halo-stage__spill--edge {
          ...
          height: 54%;
          opacity: 0.78;
          box-shadow: 0 0 96px 30px rgb(var(--halo-rgb) / 0.3);
        }
        ...
        .halo-stage__floor {
          ...
          left: 5%;
          height: 20%;
          background: radial-gradient(ellipse at 52% 0%, rgb(var(--halo-rgb) / 0.2), transparent 62%);
        ...
        @media (max-width: 767px) {
          ...
          .halo-mobile__card {
            position: relative;
            display: grid;
            grid-template-rows: 43svh minmax(17.5rem, auto);
            min-height: 78svh;
            align-content: start;
            overflow: hidden;
          ...
          .halo-mobile__card-atmosphere {
            ...
            z-index: -1;
            background:
              radial-gradient(ellipse at 50% 40%, rgb(var(--halo-rgb) / 0.3), transparent 48%),
              radial-gradient(ellipse at 50% 78%, rgb(var(--halo-rgb) / 0.2), transparent 56%);
            filter: blur(12px);
          }
          ...
          .halo-mobile__artifact :global(.halo-artifact-shell) {
            width: 100%;
          }
          ...
          .halo-mobile__copy {
            ...
            min-height: 17.5rem;
            margin: 0 auto;
            padding: 0 max(var(--page-gutter), 1.5rem) 3.4rem;
            text-align: center;
          }
          ...
          .halo-mobile__pagination button[data-active="true"]::after {
            ...
            box-shadow: 0 0 14px 2px rgb(var(--halo-rgb) / 0.72);
            transform: scaleX(1);
          }
          ...
          .halo-mobile__pagination > span {
            ...
            text-transform: uppercase;
            text-shadow: 0 0 12px rgb(var(--halo-rgb) / 0.42);
          }
        }
